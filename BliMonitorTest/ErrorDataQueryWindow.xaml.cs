...
namespace BliMonitorTest
{
    public partial class ErrorDataQueryWindow : Window
    {
        ...
        {
            new GridColumnSpec { ColumnName = "id", Header = "ID", DisplayIndex = 0 },
            new GridColumnSpec { ColumnName = "error_batch_id", Header = "관리번호", DisplayIndex = 1 },
            new GridColumnSpec { ColumnName = "created_at", Header = "생성시각", DisplayIndex = 2 },
            new GridColumnSpec { ColumnName = "source_type_text", Header = "Source", DisplayIndex = 3 },
            new GridColumnSpec { ColumnName = "channel_no", Header = "채널번호", DisplayIndex = 4, Visible = false},
            new GridColumnSpec { ColumnName = "slot_no", Header = "슬롯번호", DisplayIndex = 5 },
            new GridColumnSpec { ColumnName = "sequence_no", Header = "SEQ", DisplayIndex = 6 },
            new GridColumnSpec { ColumnName = "valid_mark_text", Header = "유효마크", DisplayIndex = 7 },
            new GridColumnSpec { ColumnName = "error_text", Header = "에러해석", DisplayIndex = 8 },
            ...
            new GridColumnSpec { ColumnName = "adc_hot_text", Header = "ADC HOT", DisplayIndex = 11 },
            new GridColumnSpec { ColumnName = "adc_cold_text", Header = "ADC COLD", DisplayIndex = 12 },
            new GridColumnSpec { ColumnName = "water_init_done_text", Header = "초기급수완료", DisplayIndex = 13 },
            new GridColumnSpec { ColumnName = "buffer_low_text", Header = "버퍼부족", DisplayIndex = 14 },
            new GridColumnSpec { ColumnName = "status_a_text", Header = "상태A", DisplayIndex = 15 },
            new GridColumnSpec { ColumnName = "status_b_text", Header = "상태B", DisplayIndex = 16 },
        ...
        // 그리드 헤어 width값 설정, ErrorColumnSpecs 함수의 Header 값 별로 항목의 width값 설정
