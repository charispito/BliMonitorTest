...
namespace DummySerialPortNs
{
    ...
    public class DummySerialPort : IDisposable
    {
        ...
        // 요청 패킷(PC→제품)
        public byte[] REQ_ErrorData = new byte[] { 0x12, 0x01, 0xB9, 0x07, 0x00, 0x40, 0x34 };
        public byte[] REQ_ErrorReset = new byte[] { 0x12, 0x01, 0XB6, 0x07, 0x00, 0x40, 0x34 };        // 자료 동일   // RES X
        public byte[] REQ_StartStopStatus = new byte[] { 0x12, 0x01, 0xA0, 0x07, 0x00, 0x59, 0x34 };   // [2] 0xA0: 상태 요청, 0xAA: START/STOP       ||    [4] 0x00:  상태 요청, 0x02:START, 0x04:STOP
        public byte[] REQ_ParameterRequest = new byte[] { 0x12, 0x01, 0xA0, 0x07, 0x00, 0x59, 0x34 };
        public byte[] REQ_ParameterSet = new byte[] {
        ...
        // 응답 패킷(제품→PC)
        public byte[] RSP_ErrorData = new byte[] {
        ...
        public byte[] RSP_StartStopStatus = new byte[] {
        ...
        public byte[] RSP_ParameterRequest = new byte[] {
